...
var server = net.createServer(function(socket) { //'connection' listener
  ...
  socket.on('data', function(chunk) {
    var route = chunk.toString().split(" ")[1];

    var notFound = '<!DOCTYPE html> <html lang="en"> <head> <meta charset="UTF-8"> <title>Element not found!</title> <link rel="stylesheet" href="/css/styles.css"> </head> <body> <h1>404</h1> <h2>Element not found!</h2> <p> <a href="/">back</a> </p> </body> </html>';
