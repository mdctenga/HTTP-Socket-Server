...
var server = net.createServer(function(socket) { //'connection' listener
  ...
  socket.on('data', function(chunk) {
    ...
    var writeHeader = function (status, serverName) {
